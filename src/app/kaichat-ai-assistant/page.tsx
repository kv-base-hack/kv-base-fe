...
export default function KaichatAIAssistant() {
  return (
          ...
          <div className="flex gap-4 justify-center tracking-normal leading-6 text-white max-md:flex-wrap">
            ...
            >
              <div className="flex-1 justify-center p-4 m-auto mt-px h-full rounded-xl backdrop-blur-[5px] bg-neutral-07 max-md:max-w-full">
                Welcome to <span className="font-bold">KaiChat</span>, your
                personal AI investment assistant. Need suggestions about{' '}
                <span className="font-bold">
                  hot coins, market trends, trading strategies, technical
                  analysis, smartmoney onchain analysis
                </span>
