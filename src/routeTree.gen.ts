...
import { Route as TradingTerminalImport } from './routes/trading-terminal'
...
const TradingTerminalRoute = TradingTerminalImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/trading-terminal': {
      preLoaderRoute: typeof TradingTerminalImport
      parentRoute: typeof rootRoute
    }
    '/academy/articles': {
