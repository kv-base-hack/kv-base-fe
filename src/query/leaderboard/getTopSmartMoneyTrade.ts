import { getTopSmartMoneyTradeUsersList } from "@/services/leaderboard/api"
import { TopSmartMoneyTradeUsersListProps } from "@/types/smartmoney"

const GET_TOP_SMART_MONEY_TRADE = 'GET_TOP_SMART_MONEY_TRADE'

export const useGetTopSmartMoneyTradeQuery = ({ chain, limit, start, address, duration, enabled, type }: TopSmartMoneyTradeUsersListProps) => ({
  queryKey: [
