  ...
  return (
    <Select value={chain} onValueChange={(val: string) => setChain(val)}>
      <SelectTrigger
        ...
        <div className="justify-center px-7 py-2.5 text-sm tracking-normal leading-5 text-white rounded-3xl border border-purple-500 border-solid shadow-lg backdrop-blur-[2px] bg-white bg-opacity-10">
          Specific Token
        </div>
      </SelectTrigger>
