  ...
  return (
    <Dialog>
      ...
      <DialogContent className="!p-0 z-[999999]">
        <div className="flex flex-col py-4 rounded-lg border-none bg-zinc-900 border-white/10 max-w-[510px]">
          <div className="flex px-4 gap-5 w-full justify-between text-xl font-bold tracking-tight leading-7 text-zinc-100 max-md:flex-wrap max-md:pl-5 max-md:max-w-full">
            <div></div>
          ...
          <div className="flex px-4 flex-col justify-center mt-4 text-base tracking-tight leading-6 text-gray-500 bg-zinc-900 bg-opacity-30 max-md:max-w-full">
                ...
                <div
                  ...
                  className={cn(
                    ...
                    tokens?.find(
                      ...
                      'z-0 bg-gradient-to-b from-[#9945FF] p-px to-[#14F195] rounded-xl',
                  )}
                >
                  <div
