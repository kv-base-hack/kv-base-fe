    ...
    return [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const formatRoi = roi.toString().includes("e") ? 0 : roi;
          return (
            <div
              className={cn(
            ...
            >
              <p>ROI:</p>
              <p>{numeral(formatRoi).format("0,0.[000]")}%</p>
            </div>
          );
        },
      },
  ...
  return (
    <>
      <Dialog>
        <DialogTrigger>
          <div
            className="whitespace-nowrap text-sm not-italic leading-5 text-[#EFEFEF] underline"
