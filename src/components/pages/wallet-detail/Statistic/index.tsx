          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              <div className="rounded-3xl h-10 p-px bg-gradient-to-r from-[#9945FF] to-[#14F195] shadow-lg backdrop-blur-[2px]">
                <div className="bg-neutral-07 whitespace-nowrap cursor-pointer rounded-3xl flex items-center justify-center px-4 h-full text-sm tracking-normal leading-5 text-white">
                  Specific Token
                </div>
              </div>
            </DialogSelectToken>
