...
import GemAnalyticsSMNewListingBuyIcon from '@/components/shared/icons/gem-analytics/SMNewListingBuyIcon'
import { cn } from '@/lib/utils'
import { useSMNewListingBuyQuery } from '@/query/onchain-signal/getSMNewListingBuys'
import { useAtomValue } from 'jotai'

export const GemAnalyticsSMNewListingBuy = () => {
    ...
    >
      <div className="flex flex-col gap-4 mt-4">
        {smNewListingBuyQuery.isFetching
          ...
          : smNewListingBuyQuery.data?.data?.smart_money_new_listing_buy?.map(
              (item, index) => (
                <div
                  key={index}
